...
function backup_efi --description "Backs up the EFI partition"
  ...
  ! _require_needed_dirs "backup_$backup_type" "source" "/Volumes/EFI"; and return 1

  mkdir -p "$basedir/EFI/"

  _print_backup_start $backup_type (_get_computer_name)
  _copy_rsync "/Volumes/EFI/" "$basedir/EFI/" "0" "1"
...
_register_backup_script "backup_local" "backup_efi"
