...
body.pixel .image img { image-rendering: pixelated; }
...
<label for='pixelcheck'><p><input type='checkbox' id='pixelcheck' onclick='togglePixel()'> Pixel image scaling</p></label>
...
toggleMinimal();
togglePixel();
document.querySelector('#minimalcheck').checked = true;
document.querySelector('#pixelcheck').checked = true;
...
#_dada_fish _register_bin regular "make_contact_sheet" "path" "make_contact_sheet.fish" "Generates an html page with all of the current dir's images"
